...
/**
 * VariancevsbudgetSearch represents the model behind the search form about `app\models\Variancevsbudget`.
 */
class VariancevsbudgetSearch extends Variancevsbudget
{
    /**
     * @inheritdoc
     */
