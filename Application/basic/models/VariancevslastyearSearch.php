...
/**
 * VariancevslastyearSearch represents the model behind the search form about `app\models\Variancevslastyear`.
 */
class VariancevslastyearSearch extends Variancevslastyear
{
    /**
     * @inheritdoc
     */
