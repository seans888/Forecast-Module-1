...
/**
 * LastforecastSearch represents the model behind the search form about `app\models\Lastforecast`.
 */
class LastforecastSearch extends Lastforecast
{
    /**
     * @inheritdoc
     */
